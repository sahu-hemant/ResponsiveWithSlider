...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
	...
	<section >
		...
		<div class="slogan">
			...
			<h4>BHIYA HAM TO AISE HI KAAM KARTE HE JAME TO THIK</h4>
		</div>
					...
					<div class="wow fadeInLeft" data-wow-delay="0.2s">
						<div class="service-box">
							...
							<div class="service-desc">
								<h5>Print</h5>
								<p>Neta logo ke poster, Shadi ki Patrika, Mangal ka duplicate (Dusra Gola), Sab kuch bhiya.</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-sm-3 col-md-3">
					<div class="wow fadeInUp" data-wow-delay="0.2s">
						<div class="service-box">
							...
							<div class="service-desc">
								<h5>Photography</h5>
								<p>Bhiya bahut shouk he, Apne padosi Pappu bhiya ki shadi me khub heche photo..</p>
							</div>
						</div>
					</div>
				</div>
				<div class="col-sm-3 col-md-3">
					<div class="wow fadeInRight" data-wow-delay="0.2s">
						<div class="service-box">
							...
							<div class="service-desc">
								<h5>Cloud System</h5>
								<p>Kounsi bhasha bol rahe ho bhiya, ke riya hu gali wali mat dena.</p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-8 col-lg-offset-2">
						<div class="wow bounceInDown" data-wow-delay="0.4s">
							<div class="section-heading">
								<h2>Kya Ukhad Lega Mail karke</h2>
								<i class="fa fa-2x fa-angle-down"></i>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="name"> Naam kya he tera</label> <input type="text"
											class="form-control" id="name" placeholder="Enter name"
											required="required" />
									</div>
									<div class="form-group">
										<label for="email"> Email-Vmail</label>
									...
									<div class="form-group">
										<label for="subject"> Kayeko pareshan kar riya he</label> <select id="subject"
								...
								<div class="col-md-12">
									<button type="submit" class="btn btn-skin pull-right"
										id="btnContactUs">Le Mar, Bhej</button>
								</div>
							</div>
						</form>
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-lg-12">
					...
					<p>&copy;Hamari Koi Shakha Nahi He-2015.</p>
				</div>
			</div>
		</div>
	</footer>
